...
const dataBase = require("../dabaBase");
...
module.exports = class Accionable {
    ...
    static async getbyId(idAccionable){
        ...
        if (rows.length === 0)
            throw new Error("Accionable no encontrada");
    ...
    async save(){
        const query = `INSERT INTO Accionable(nombreAccionable, storyPoints, labelAccionable, prioridadAccionable, estadoAccionable, estadoIssue, fechaCreacion, fechaFinalizacion) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`
